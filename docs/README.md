# Mentor Frontend - Grade Bento

![Visualização do design do desafio de codificação em grade do Bento](./preview.jpg)
...
**Para fazer este desafio, você precisa de um bom conhecimento de HTML e CSS.**

## O desafio

Seu desafio é construir essa grade de bento e fazer com que pareça o mais próximo possível do design.
...
Os dois componentes na coluna esquerda no desktop são colocados na parte inferior no celular. Esta é uma boa oportunidade para praticar suas habilidades de posicionamento de CSS Grid.
...
Se quiser que o arquivo de design Figma ganhe experiência no uso de ferramentas profissionais e crie projetos mais precisos com mais rapidez, você pode [inscrever-se como membro PRO] (https://www.frontendmentor.io/pro).
